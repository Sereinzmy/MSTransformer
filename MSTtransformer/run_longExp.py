...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='PatchTST-01', help='model id')
    parser.add_argument('--model', type=str, default='MSTransformer',
    ...
    # optimization
    parser.add_argument('--num_workers', type=int, default=10, help='data loader num workers') # local is not work
